export default function Routes($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    ...
    .state('public.root.subscribe', {
      ...
      views: {
        '': {
          template: require('./Public/Subscribe/subscribe.html'),
    ...
    .state('public.root.faq', {
      ...
      views: {
        '': {
          template: require('./Public/FAQ/faq.html'),
    ...
    .state('public.root.products', {
      ...
      views: {
        '': {
          template: require('./Public/Products/products/products.html'),
    ...
    .state('public.root.product-details', {
      ...
      views: {
        '': {
          template: require('./Public/Products/product-details/product-details.html'),
    ...
    .state('public.root.vendor-details', {
      ...
      views: {
        '': {
          template: require('./Public/Vendor/vendor-details/vendor-details.html'),
    ...
    .state('public.root.vendor-list', {
      ...
      views: {
        '': {
          template: require('./Public/Vendor/vendor-list/vendor-list.html'),
    ...
    .state('admin.root.profile', {
      ...
      views: {
        '': {
          template: require('./Admin/Profile/profile.html'),
    ...
    .state('admin.root.inventory', {
      ...
      views: {
        '': {
          template: require('./Admin/Inventory/inventory/inventory.html'),
