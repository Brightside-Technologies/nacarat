export default function $dialogHelper($mdDialog, $mdMedia, $state) {
    ...
    helper.hide = function(arg) {
        return $mdDialog.hide(arg);
    };

    helper.cancel = function(arg) {
        return $mdDialog.cancel(arg);
    };
        ...
        return $mdDialog
            .show({
                controller: function PromptDialogController($scope, locals) {
                    ...
                    function keypress(e) {
                        if (e.keyCode === 13) {
                            if (vm.form.$valid) (vm.confirmBtn.action || $mdDialog.hide)(vm.modelValue);
                        }
                    }
